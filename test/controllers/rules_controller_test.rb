...
class RulesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rule" do
    assert_difference('Rule.count') do
      post rules_url, params: { rule: { rule: @rule.rule, rule_description: @rule.rule_description } }
    end
  ...
  test "should update rule" do
    patch rule_url(@rule), params: { rule: { rule: @rule.rule, rule_description: @rule.rule_description } }
